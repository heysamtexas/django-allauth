...
2. **Install django-allauth in development mode**
...
1. **Install Nix** (If you don't have it already)
   ...
   Follow the [official installation instructions](https://nixos.org/download.html).
...
- [Project Source](https://codeberg.org/allauth/django-allauth)
